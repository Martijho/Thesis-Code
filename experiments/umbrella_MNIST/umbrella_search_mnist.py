...
search_hyper_param = {'batch_size': 16,
                      ...
                      'population_size': 64}
dir_name            = '../../logs/umbrella_MNIST/umbrella_3layerConv_0.975'
...
while True:
    ...
    log['path3'].append(path3)
    log['eval1'].append(eval1)
    log['eval2'].append(eval2)
    log['eval3'].append(eval3)
    log['gen1'].append(gen1)
    log['gen2'].append(gen2)
    log['gen3'].append(gen3)
    log['avg_training1'].append(avg1)
    log['avg_training2'].append(avg2)
    log['avg_training3'].append(avg3)
    log['reuse12'].append(reuse[0])
    log['reuse13'].append(reuse[1])
    log['reuse23'].append(reuse[2])
    ...
    log['base_path'].append(pathB)
    log['base_eval'].append(evalB)
    log['base_gen'].append(genB)
    log['base_avg_training'].append(avgB)
    '''

    with open(dir_name + '/log.pkl', 'wb') as f:
        pkl.dump(log, f)
    print('NUMBER OF EXPERIMENTS SAVED:', len(log['path1']))
